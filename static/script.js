...
function createAlertCard(alert) {
  ...
  // Correctly add event listener for "View Details" button
    const viewDetailsBtn = card.querySelector('.view-details-btn');
    viewDetailsBtn.addEventListener('click', () => {
        console.log("View Details clicked for alert:", alert);
...
// Function to show alert details (updated to populate the new page)
function showAlertDialog(alert) {
  ...
  // Add content to the dialog (similar to the alert card but with more details)
  dialog.innerHTML = `
